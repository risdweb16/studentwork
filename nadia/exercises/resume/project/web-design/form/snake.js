window.onload = function()
{
    ...
    for (var i = snake.length - 1; i >= 0; i--) {
        ...
        if (i === 0) {
            ...
            // see if snake got the food and act accordingly
            // add food element
            // add extra point to tail
            ...
            // make sure head is not hitting other part of its body
            // if it does, end game
    ...
    function drawMain() 
    {
        ctx.lineWidth = 2; // border 2 pixels
        ctx.strokeStyle = "blue"; //border color
 
        // border drawn outside of the rectangle
        // leave a 20 pixels space on the top to draw the interface.
    ...
    function showGameOver()
    {
    	...
    	ctx.fillStyle = 'black';
    	ctx.font = '16px Impact, Charcoal, sans-serif';
